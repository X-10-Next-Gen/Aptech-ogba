          ...
          >
            <form onSubmit={handleSubmit(onSubmit)} className="bg-yellow-500 p-8 rounded-lg shadow-lg w-96">
              ...
              <div className="mb-4">
                ...
                <input type="text" {...register("name", { required: "Name is required" })} className="w-full p-2 border-black rounded border-2 text-black focus:outline-none focus:ring-2 focus:ring-blue-500" />
              ...
              <button type="submit" className="w-full bg-black text-white p-2 rounded hover:bg-red-700 transition-all">
                Sign Up
              </button>
            </form>
          </div>
